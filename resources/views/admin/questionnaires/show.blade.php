...
@section('title', 'Detalhes pesquisa')

@section('content_header')

    <div class="card-header">
        <h3 class="text-center">Detalhes da pesquisa</h3>
    </div>
    ...
    <div class="card">
        <div class="card-success">
            <div class="card card-header">
                <div class="row">
                    <h3 class="text-left mt-3 mb-2 ml-3">Detalhes da Pesquisa</h3>
                </div>
            </div>
            ...
            <div class="card-footer">
                <div class="col-sm-10">
                    ...
                    <div class="button-group">
                        <a href=" {{ route('questionnaires.index') }} " class="btn btn-success btn-sm ml-2 mt-2">Home</a>
                    </div>
                </div>
            </div>
        </div>
