...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form id="form_opcao_editar" class="form_opcao_editar"
                        action="{{ route('options.update', [$option->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-12">
                                <div class="h-100 p-5 bg-light border rounded-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="hidden" class="form-control" value="{{ $option->id }}"
                                            name="id" />
                                        <span class="input-group-text" id="basic-addon2">Opção de resposta</span>
                                        <input type="text" class="form-control" value="{{ $option->titulo }}"
                                            name="titulo" aria-label="Recipient's option" aria-describedby="basic-addon2" />
                                    </div>
